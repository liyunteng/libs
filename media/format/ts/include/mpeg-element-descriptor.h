/*
 * mpeg-element-descriptor.h - mpeg-element-descriptor
 *
 * Date   : 2021/03/30
 */
#ifndef __MPEG_ELEMENT_DESCRIPTOR_H__
#define __MPEG_ELEMENT_DESCRIPTOR_H__
...
#endif /* __MPEG_ELEMENT_DESCRIPTOR_H__ */
