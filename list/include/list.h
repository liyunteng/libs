 ...
 */
static inline void
__list_add(struct list_head *xnew, struct list_head *prev, struct list_head *next)
{
    next->prev = xnew;
    xnew->next = next;
    xnew->prev = prev;
 ...
 */
static inline void
list_add(struct list_head *xnew, struct list_head *head)
{
 ...
 */
static inline void
list_add_tail(struct list_head *xnew, struct list_head *head)
{
 ...
 */
static inline void
list_replace(struct list_head *old, struct list_head *xnew)
{
    xnew->next       = old->next;
    xnew->next->prev = xnew;
    xnew->prev       = old->prev;
...
static inline void
list_replace_init(struct list_head *old, struct list_head *xnew)
{
