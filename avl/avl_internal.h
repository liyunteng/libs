...
typedef avl_tree_walk_code_td (*avl_walker_type_internal)(avl_tree_node_type_td *node,
                                                          void *internal_ctx, void *ctx);

typedef avl_tree_compare_code_td (*avl_compare_type_internal)(avl_tree_node_type_td *node_one,
                                                              avl_tree_node_type_td *node_two,
                                                              void *                 ctx);

extern avl_tree_walk_code_td avl_walk_internal(avl_tree_node_type_td *  avl_node,
                                               avl_walker_type_internal proc, void *internal_ctx,
                                               void *paramptr);

extern void *avl_get_greater_equal_v2(avl_tree_node_type_td *top, avl_tree_node_type_td *current,
                                      avl_compare_type_internal compare_func, void *ctx,
                                      bool *is_equal);

extern void *avl_get_smaller_equal_v2(avl_tree_node_type_td *top, avl_tree_node_type_td *current,
                                      avl_compare_type_internal compare_func, void *ctx,
                                      bool *is_equal);

extern void *avl_get_next_v2(avl_tree_node_type_td *top, avl_tree_node_type_td *current,
                             avl_compare_type_internal compare_func, void *ctx);

extern void *avl_get_prev_v2(avl_tree_node_type_td *top, avl_tree_node_type_td *current,
                             avl_compare_type_internal compare_func, void *ctx);

extern void *avl_insert_internal(avl_tree_node_type_td **top, avl_tree_node_type_td *new,
                                 bool *balancing_needed, avl_compare_type_internal compare_func,
                                 void *ctx, bool *is_new_nod);

extern void *avl_delete_internal(avl_tree_node_type_td **top, avl_tree_node_type_td *target,
                                 bool *balancing_needed, avl_compare_type_internal compare_func,
                                 void *ctx);

extern void *avl_search_internal(avl_tree_node_type_td *top, avl_tree_node_type_td *goal,
                                 avl_compare_type_internal compare_func, void *ctx);
...
avl_tree_node_type_td *avl_delete_replacement(avl_tree_node_type_td **link, bool *balancing_needed);
...
extern void avl_balance_right_internal(avl_tree_node_type_td **element, bool *balancing_needed);

extern void avl_balance_left_internal(avl_tree_node_type_td **element, bool *balancing_needed);

extern avl_tree_node_type_td *avl_delete_replacement_internal(avl_tree_node_type_td **link,
