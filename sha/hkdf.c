 ...
 */
int
hkdf(SHAversion whichSha, const unsigned char *salt, int salt_len,
 ...
 */
int
hkdfExtract(SHAversion whichSha, const unsigned char *salt, int salt_len,
 ...
 */
int
hkdfExpand(SHAversion whichSha, const uint8_t prk[], int prk_len,
 ...
 */
int
hkdfReset(HKDFContext *context, enum SHAversion whichSha,
 ...
 */
int
hkdfInput(HKDFContext *context, const unsigned char *ikm, int ikm_len)
{
    if (!context)
        return shaNull;
 ...
 */
int
hkdfFinalBits(HKDFContext *context, uint8_t ikm_bits,
 ...
 */
int
hkdfResult(HKDFContext *context, uint8_t prk[USHAMaxHashSize],
